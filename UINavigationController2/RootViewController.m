...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.secondViewController.strId = [NSString stringWithFormat:@"%@",[[self.navRowList objectAtIndex:indexPath.row] objectForKey:@"ID"]];
    self.secondViewController.strName = [[self.navRowList objectAtIndex:indexPath.row] objectForKey:@"NAME"];
    self.secondViewController.strQty = [NSString stringWithFormat:@"%@",[[self.navRowList objectAtIndex:indexPath.row] objectForKey:@"QTY"]];
    //跳转
